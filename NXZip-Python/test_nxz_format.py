...
"""
NXZ Format テスト
NEXUSハイブリッド + SPE統合によるNXZ標準フォーマットのテスト
...
from nxzip.formats.nxz_format import NXZFile, create_nxz_file, extract_nxz_file


def test_nxz_format():
    """NXZ フォーマットの包括的テスト"""
    
    print("🚀 NXZ フォーマットテスト開始")
    print("=" * 70)
...
if __name__ == "__main__":
    # メインテスト
    success, results = test_nxz_format()
