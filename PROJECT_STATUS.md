...
|---------|----------------|----------|----------|
| **nexus_quantum_png_structure.py** | PNG, JPEG | **100%完全可逆性** | PNG構造保存・量子圧縮 |
| **nexus_adaptive_huffman.py** | 全形式 | **100%完全可逆性** | 最適化適応型エントロピー圧縮 |
| **nexus_hybrid_simple.py** | 全形式 | **73.4%圧縮率** | LZ77+静的Huffman（推奨エンジン） |
...
### ハイブリッド圧縮 (nexus_hybrid_engine.py)
- **LZ77辞書圧縮**: スライディングウィンドウによるパターンマッチング
- **FGK適応型ハフマン**: 動的ツリー更新による最適エントロピー圧縮
- **4フェーズ処理**: LZ77→シリアライズ→FGK→パッキング
- **実績**: 56.3%圧縮率 (316→123バイト), 100%可逆性保証
